...
allowed_for_admin_user = RoleChecker({UserRole.admin, UserRole.subscriber})
allowed_for_admin_user_executor = RoleChecker({UserRole.admin, UserRole.user, UserRole.executor})
